...
public class ServiceLocator {
    ...
    public RedoViewModel RedoViewModel =>
        _serviceProvider.GetRequiredService<RedoViewModel>();
    ...
    public ServiceLocator() {
        ...
        serviceCollection.AddSingleton<IWrongNavigationService, WrongNavigationService>();
        serviceCollection.AddSingleton<RedoViewModel>();
