...
public class MainViewModel : ViewModelBase
{
    ...
    public MainViewModel(IMenuNavigationService menuNavigationService, IWrongNavigationService  wrongNavigationService , IPoetryStorage poetryStorage)
    {
    ...
    public void SetWrongContent(Exercise para)
    {
        var redoViewModel = new RedoViewModel(_poetryStorage, para);

        PushContent(redoViewModel);
    }
